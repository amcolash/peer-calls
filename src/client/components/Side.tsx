...
export const Side = React.memo(function Side(props: SideProps) {
  const { className, zIndex, ...otherProps } = props;
  return (
    <div className={classnames('side', className, { ...otherProps })} style={{ alignItems: props.align || 'center', zIndex }}>
      {props.children}
    </div>
  );
});
